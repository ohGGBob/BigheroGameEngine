...
namespace BigHero::Core
{
    ...
    private:
        ...
        // 把条目移到 MRU 端（list 前端）
        void Touch(const std::list<std::string>::iterator it)
        {
    ...
    public:
        ...
        template <typename T>
        AssetCache<T>& Cache(size_t capacity, typename AssetCache<T>::Factory factory)
        {
