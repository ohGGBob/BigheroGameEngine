...
class AssetMetadata {
public:
    enum class AssetType : uint8_t { Texture=0, Mesh=1, Shader=2, Material=3, AnimationClip=4, Audio=5, Font=6, Scene=7, Unknown=8 };
    enum class LoadState : uint8_t { Unloaded=0, Loading=1, Loaded=2, Failed=3 };

    AssetMetadata() = default;
    AssetMetadata(std::string path, AssetType type)
    ...
    static const char* TypeName(AssetType t) {
        switch (t) {
            case AssetType::Texture: return "Texture"; case AssetType::Mesh: return "Mesh";
            case AssetType::Shader: return "Shader"; case AssetType::Material: return "Material";
            case AssetType::AnimationClip: return "AnimationClip"; case AssetType::Audio: return "Audio";
            case AssetType::Font: return "Font"; case AssetType::Scene: return "Scene";
