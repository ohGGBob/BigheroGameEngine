...
private:
    // Use __PRETTY_FUNCTION__ to get a type-stable name string. This collapses
    // to the unspecialized template for most compilers but is fine as a unique
    // per-type tag for id derivation.
    template <class T>
