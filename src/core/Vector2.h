...
struct Vector2
{
    ...
    static Vector2 Min(const Vector2& a, const Vector2& b) { return {a.x < b.x ? a.x : b.x, a.y < b.y ? a.y : b.y}; }
    static Vector2 Max(const Vector2& a, const Vector2& b) { return {a.x > b.x ? a.x : b.x, a.y > b.y ? a.y : b.y}; }
    static float Distance(const Vector2& a, const Vector2& b) { return (a - b).Magnitude(); }
    static const Vector2& Zero()
    {
        static Vector2 z(0, 0);
        return z;
    }
    static const Vector2& One()
    {
        static Vector2 o(1, 1);
        return o;
    }
};
