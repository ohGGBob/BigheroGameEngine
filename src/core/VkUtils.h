...
namespace BigHero
{
    ...
    [[nodiscard]] inline VkFormat FindSupportedFormat(VkPhysicalDevice gpu,
    ...
    [[nodiscard]] inline uint32_t FindMemoryType(VkPhysicalDevice gpu,
        uint32_t typeFilter, VkMemoryPropertyFlags requiredProps)
    {
