...
namespace BigHero
{
    ...
    public:
        ...
        [[nodiscard]] static glm::vec3 SampleEquirect(const glm::vec3& dir,
        ...
        [[nodiscard]] static std::array<std::vector<glm::vec3>, 6> EquirectToCube(
    ...
    private:
        ...
        void DecodeScanline(const uint8_t*& cur, const uint8_t* end,
