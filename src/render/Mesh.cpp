...
{
    void Mesh::Create(const Context& ctx, const void* vertexData, VkDeviceSize vertexBytes,
        uint32_t vertexCount, const uint32_t* indices, uint32_t indexCount)
    {
        ...
        vertexBuffer_.Create(ctx, vertexBytes,
        ...
        indexBuffer_.Create(ctx, indexBytes,
