...
namespace BigHero::Render
{
    namespace detail
    {
        ...
        struct SpirvBuffer
        {
            ...
            [[nodiscard]] const std::vector<std::uint32_t>& GetData() const noexcept
            {
                return data;
            }
    ...
    [[nodiscard]] inline VkShaderModule CreateShaderModule(
        VkDevice device,
        const detail::SpirvBuffer& spirvBuffer
    )
    {
    ...
    struct ShaderModuleHandle
    {
        ...
        ShaderModuleHandle(VkDevice dev, const detail::SpirvBuffer& spirvData)
            : device(dev)
        {
