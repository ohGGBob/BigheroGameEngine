...
namespace BigHero::Scene
{
    ...
    inline std::vector<Vertex> BuildCubeVertices()
    {
        ...
        const std::array<glm::vec3, 6> faceColors = {
            glm::vec3(0.85f, 0.33f, 0.30f),
            glm::vec3(0.33f, 0.72f, 0.38f),
            glm::vec3(0.30f, 0.52f, 0.92f),
            glm::vec3(0.95f, 0.78f, 0.30f),
            glm::vec3(0.72f, 0.42f, 0.88f),
            glm::vec3(0.35f, 0.80f, 0.80f)
        };
    ...
    inline std::vector<Vertex> BuildGroundVertices()
    {
        ...
        const std::array<glm::vec2, 4> uvs = {
            glm::vec2(0.0f, 0.0f), glm::vec2(5.0f, 0.0f),
            glm::vec2(5.0f, 5.0f), glm::vec2(0.0f, 5.0f)
        };
