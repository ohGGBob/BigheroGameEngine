...
namespace BigHero::Scene
{
    ...
    [[nodiscard]] inline glm::mat4 LocalToWorldMatrix(
        const Transform& t, const std::vector<Transform>& transforms)
    {
    ...
    // 严格保守（对任意旋转/非均匀缩放都正确）。
    [[nodiscard]] inline std::array<glm::vec3, 2> WorldAabb(
        const glm::mat4& world, const glm::vec3& aabbMin, const glm::vec3& aabbMax)
    {
